...
export const KonamiEasterEgg = () => {
  ...
  const fireConfetti = useCallback(() => {
    ...
    // Ancienne palette bleue codée en dur. Le canvas confetti exige des
    // couleurs littérales : on lit l'accent effectif du thème au tir.
    const accent =
      getComputedStyle(document.documentElement)
        .getPropertyValue("--primary")
        .trim() || "#e5484d";
    const colors = [accent, accent, "#ffffff"];
